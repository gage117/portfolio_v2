...
function About() {
	return (
		<section id="About">
			<ScrollAnimation animateIn='fadeIn' animateOnce={true} duration={0.75}>
			...
			<section className='what-i-do'>
				...
				<hr />
				<ScrollAnimation animateIn='slideInLeft' animateOnce={true} duration={0.75}>
					<article>
				...
				<ScrollAnimation animateIn='slideInRight' animateOnce={true} duration={0.75}>
					<article>
						<section className='wid-header'>
