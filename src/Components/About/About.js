	...
	return (
		<section id="About">
			...
			<section className='what-i-do'>
				...
				<hr />
				<ScrollAnimation animateIn='slideInLeft' animateOnce={true} duration={0.75} offset={0} initiallyVisible={true}>
					<article>
				...
				<ScrollAnimation animateIn='slideInRight' animateOnce={true} duration={0.75} offset={0} initiallyVisible={true}>
					<article>
						<section className='wid-header'>
