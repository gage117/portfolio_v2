...
function About() {
	return (
		<section id="About">
			<ScrollAnimation animateIn='fadeIn' animateOnce={true} duration={0.75} offset={0}>
			...
			<section className='what-i-do'>
				...
				<hr />
				<ScrollAnimation animateIn='slideInLeft' animateOnce={true} duration={0.75} offset={0}>
					<article>
				...
				<ScrollAnimation animateIn='slideInRight' animateOnce={true} duration={0.75} offset={0}>
					<article>
						<section className='wid-header'>
